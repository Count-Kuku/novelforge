...
def _render_all_pages() -> tuple[list[str], dict[str, list[str]]]:
    ...
    with isolated_workspace("novelforge_ui_restructure_"):
        ...
        alternate_views = [
            ...
            ("正文生成", scoped_widget_key("chapter_page_view", project_name, "default", 1), "3 · 审阅整理", "章节写作 / 审阅"),
            ("章节评价", scoped_widget_key("evaluation_view", project_name, "default", 1), "评价结果", "章节审阅 / 评价结果"),
