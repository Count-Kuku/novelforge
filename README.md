...
- 项目级创作配置：任务性质、目标篇幅、生成层级、资料参考强度，均支持自定义
- 创作任务向导：用中文目标快速生成项目创作配置
...
- 轻量写作指导参数
- 应用内模型地址与密钥配置
- 分组式工作台侧边栏导航，按工作台 / 规划 / 写作 / 资料 / 系统组织页面
- 项目感知的页面头部与统一卡片化界面样式
...
项目可以保存一份创作配置，用于描述当前故事更适合走哪种生成路径。
