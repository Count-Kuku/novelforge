...
async function send() {
  ...
  try {
    ...
    await api.streamTurn(
      ...
      { user_message: message, action_type: actionType, enable_web_search: webEnabled.value },
      (event, data) => {
